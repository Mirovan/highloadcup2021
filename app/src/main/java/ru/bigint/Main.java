...
public class Main {
    ...
    private final static int areaSize = 350;
...
//                        Logger.log("Response: " + responseBody);
        ...
        for (int treasureCount = treasureAmountList.size()-1; treasureCount >= 0; treasureCount++) {
            List<Point> points = treasureMap.get(treasureCount);
